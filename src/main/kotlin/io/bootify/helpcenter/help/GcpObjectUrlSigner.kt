...
class GcpObjectUrlSigner(
    ...
    override fun signGetUrl(key: String, contentType: String?): String {
        val blob = com.google.cloud.storage.BlobInfo.newBuilder(props.bucketName, key)
        ...
        val url = storage.signUrl(
            ...
            com.google.cloud.storage.Storage.SignUrlOption.httpMethod(com.google.cloud.storage.HttpMethod.GET),
